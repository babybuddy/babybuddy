...
# LDAP
LDAP_AUTH = bool(strtobool(os.environ.get("LDAP_AUTH") or "False"))
if LDAP_AUTH:
    import ldap
    ...
    AUTH_LDAP_GROUP_SEARCH = LDAPSearch(
        os.getenv("AUTH_LDAP_GROUP_SEARCH_BASE_DN"),
        ldap.SCOPE_SUBTREE,
        os.getenv("AUTH_LDAP_GROUP_SEARCH_FILTER", "(objectClass=groupOfNames)"),
    )
    AUTH_LDAP_GROUP_TYPE = GroupOfNamesType(name_attr="cn")
    AUTH_LDAP_REQUIRE_GROUP = os.getenv("AUTH_LDAP_REQUIRE_GROUP")
    AUTH_LDAP_ALWAYS_UPDATE_USER = bool(
        strtobool(os.environ.get("AUTH_LDAP_ALWAYS_UPDATE_USER") or "True")
    )
