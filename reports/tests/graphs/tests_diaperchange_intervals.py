...
from reports.graphs import diaperchange_intervals


class DiaperChangeIntervalsTestCase(TestCase):
    def setUp(self):
    ...
    def test_diaperchange_intervals(self):
        ...
        html, js = diaperchange_intervals(
