...
from reports.graphs import feeding_duration


class FeedingDurationTestCase(TestCase):
    def setUp(self):
    ...
    def test_feeding_duration(self):
        ...
        html, js = feeding_duration(models.Feeding.objects.filter(child=c))
