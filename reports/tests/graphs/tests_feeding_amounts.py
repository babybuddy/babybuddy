...
from reports.graphs import feeding_amounts


class FeedingAmountsTestCase(TestCase):
    def setUp(self):
    ...
    def test_feeding_amounts(self):
        ...
        html, js = feeding_amounts(models.Feeding.objects.filter(child=c))
